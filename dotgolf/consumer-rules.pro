...
# continue to resolve after shrinking in consuming apps.
...
-keepclassmembers class com.futureworkshops.dotgolf.data.model.** {
    kotlinx.serialization.KSerializer serializer(...);
}
-keepclassmembers class com.futureworkshops.dotgolf.data.model.**$$serializer {
    *;
}
